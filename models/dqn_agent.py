...
finalnet = finalNetwork(32, 64, n_actions=16 if using_discrete else 72, using_discrete=using_discrete)
...
if __name__ == '__main__':
    ...
    # Only run one experiment at a time (i.e. At the moment dqn_agent.py stops execution after completing one call of RUN_DQN_ALGORITHM)
    results_file = open(f"dqn_results.txt", "w")
    RUN_DQN_ALGORITHM(results_file, num_episodes=10, num_time_steps=10, eps=0.8, min_eps=0.05, discount_rate = 0.6)
